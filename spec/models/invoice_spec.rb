...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    it 'calculates total discount for the invoice' do
      expect(@invoice_1.total_discount.round(2)).to eq(7.2)
    end

    it 'calculates total discounted revenue for the invoice' do
      expect(@invoice_1.total_discounted_revenue.round(2)).to eq(154.8)
    end
  end
end
